...
public final class EpicBattle extends AbstractAutoEvent
{
	...
	protected void prepareEndState()
	{
		...
		{
			World.sendAnnounce("The winning team of players!");
			winner = 1;
		}
	...
	protected void prepareStartState()
	{
		...
		World.sendAnnounce("The event will involveь " + players.size() + " player(s)");
		World.sendAnnounce("The battle will start in 1 minute.");
