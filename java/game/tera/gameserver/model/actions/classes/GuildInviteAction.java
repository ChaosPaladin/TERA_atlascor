...
public class GuildInviteAction extends PlayerAction
{
	...
	public synchronized void assent(Player player)
	{
		...
		player.sendMessage("You entered into \"" + guild.getName() + "\"!");
	}
	...
	public void invite()
	{
		...
		if(guild == null)
		{
			actor.sendMessage("You are not a member of a guild.");
			return;
		}
	...
	protected boolean test(Player actor, Player target)
	{
		...
		{
			actor.sendMessage("You can not invite to guild.");
			return false;
		}
		...
		{
			actor.sendMessage("The player is too far.");
			return false;
		}*/
