...
public abstract class AbstractSkill implements Skill
{
	...
	public boolean checkCondition(Character attacker, float targetX, float targetY, float targetZ)
	{
		...
		{
			attacker.sendMessage("Do not use in the immobilized state.");
			return false;
		}
		...
		{
			attacker.sendMessage("You do not have HP.");
			return false;
		}
		...
		if(template.getItemIdConsume() != 0)
		{
			...
			{
				attacker.sendMessage("You do not have the necessary things in the Inventory.");
				return false;
			}
		}
